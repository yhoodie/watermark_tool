...
| Third-party Domain | `app-dysgncsaheyp-api-DLEO7Vjd8Qea-gateway.appmiaoda.com` |
| 计费 | 启用；按调用次数计费 |
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstream = await fetch(
    "https://app-dysgncsaheyp-api-DLEO7Vjd8Qea-gateway.appmiaoda.com/rest/2.0/ocr/v1/air_ticket",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/x-www-form-urlencoded",
