...
| 方法 | POST |
| Endpoint | `https://app-dysgncsaheyp-api-V9gDzg15D7BL-gateway.appmiaoda.com/v1/video_generation` |
...
serve(async (req: Request): Promise<Response> => {
  ...
  // --- Call upstream ---
  const upstream = await fetch("https://app-dysgncsaheyp-api-V9gDzg15D7BL-gateway.appmiaoda.com/v1/video_generation", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
...
| 方法 | GET |
| Endpoint | `https://app-dysgncsaheyp-api-zYkZz2eDWvPL-gateway.appmiaoda.com/v1/query/video_generation` |
| 计费 | 不计费 |
...
serve(async (req: Request): Promise<Response> => {
  ...
  // --- Call upstream ---
  const url = new URL("https://app-dysgncsaheyp-api-zYkZz2eDWvPL-gateway.appmiaoda.com/v1/query/video_generation");
...
| 方法 | GET |
| Endpoint | `https://app-dysgncsaheyp-api-GYX1ld3ExkQa-gateway.appmiaoda.com/v1/files/retrieve` |
| 计费 | 不计费 |
...
serve(async (req: Request): Promise<Response> => {
  ...
  const url = new URL("https://app-dysgncsaheyp-api-GYX1ld3ExkQa-gateway.appmiaoda.com/v1/files/retrieve");
