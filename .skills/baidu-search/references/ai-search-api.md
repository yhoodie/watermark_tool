...
| third_part_domain | `app-dysgncsaheyp-api-rY7JZ6jqr6dL-gateway.appmiaoda.com` |
| 计费 | 计费信息以平台实际配置为准 |
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstream = await fetch(
    "https://app-dysgncsaheyp-api-rY7JZ6jqr6dL-gateway.appmiaoda.com/v2/ai_search/chat/completions",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
