...
| third_part_domain | `app-dysgncsaheyp-api-Q9KWnzwVQMk9-gateway.appmiaoda.com` |
...
| Endpoint | `POST https://app-dysgncsaheyp-api-Q9KWnzwVQMk9-gateway.appmiaoda.com/v1/images/editing/expand` |
...
| Endpoint | `GET https://app-dysgncsaheyp-api-rLobR6vwZJJ9-gateway.appmiaoda.com/v1/images/editing/expand/{task_id}` |
| Content-Type | `application/json` |
...
| Endpoint | `GET https://app-dysgncsaheyp-api-AalZkPVdZX8L-gateway.appmiaoda.com/v1/images/editing/expand` |
| Content-Type | `application/json` |
...
async function pollTask(taskId: string, apiKey: string): Promise<TaskDetail> {
  ...
  while (Date.now() < deadline) {
    ...
    const res = await fetch(
      `https://app-dysgncsaheyp-api-rLobR6vwZJJ9-gateway.appmiaoda.com/v1/images/editing/expand/${encodeURIComponent(taskId)}`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
...
serve(async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    const createRes = await fetch(
      "https://app-dysgncsaheyp-api-Q9KWnzwVQMk9-gateway.appmiaoda.com/v1/images/editing/expand",
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
