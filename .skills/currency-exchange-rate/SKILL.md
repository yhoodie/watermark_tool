...
- **Endpoint**: `POST https://app-dysgncsaheyp-api-ELbWz8OmBW5Y-gateway.appmiaoda.com/exchange-rate-v2/single`
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstream = await fetch(
    "https://app-dysgncsaheyp-api-ELbWz8OmBW5Y-gateway.appmiaoda.com/exchange-rate-v2/single",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/x-www-form-urlencoded",
