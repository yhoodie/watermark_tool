...
- **Endpoint**：`GET https://app-dysgncsaheyp-api-79jK62Ze2pQL-gateway.appmiaoda.com/location/ip`
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstreamUrl = `https://app-dysgncsaheyp-api-79jK62Ze2pQL-gateway.appmiaoda.com/location/ip${
