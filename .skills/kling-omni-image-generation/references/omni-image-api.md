...
| Third-party Domain | `app-dysgncsaheyp-api-DLEO4zbkvoea-gateway.appmiaoda.com` |
...
| 方法 | POST |
| Endpoint | `https://app-dysgncsaheyp-api-DLEO4zbkvoea-gateway.appmiaoda.com/v1/images/omni-image` |
...
| 方法 | GET |
| Endpoint | `https://app-dysgncsaheyp-api-79jK6nw4zxDL-gateway.appmiaoda.com/v1/images/omni-image/{id}` |
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstream = await fetch(
    "https://app-dysgncsaheyp-api-DLEO4zbkvoea-gateway.appmiaoda.com/v1/images/omni-image",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
...
serve(async (req: Request): Promise<Response> => {
  ...
  // --- 调用上游查询接口 ---
  const upstream = await fetch(
    `https://app-dysgncsaheyp-api-79jK6nw4zxDL-gateway.appmiaoda.com/v1/images/omni-image/${taskId}`,
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
...
| 方法 | POST |
| Endpoint | `https://app-dysgncsaheyp-api-eLMlPzV7qWJ9-gateway.appmiaoda.com/v1/images/omni-image` |
...
async function submitOmniImageEditTask(
  ...
  const response = await fetch(
    "https://app-dysgncsaheyp-api-eLMlPzV7qWJ9-gateway.appmiaoda.com/v1/images/omni-image",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
