...
- **Endpoint**: `POST https://app-dysgncsaheyp-api-o9wN0mk1DAPa-gateway.appmiaoda.com/driverexam/query`
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstream = await fetch(
    `https://app-dysgncsaheyp-api-o9wN0mk1DAPa-gateway.appmiaoda.com/driverexam/query?${params.toString()}`,
    {
      method: "POST",
      headers: {
