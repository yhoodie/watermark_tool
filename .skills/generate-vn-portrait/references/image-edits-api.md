...
| Endpoint | `POST http://app-dysgncsaheyp-api-rY7JzDpZVBQL-gateway.appmiaoda.com/v1/images/edits` |
...
async function editImage(params: EditImageParams): Promise<EditImageResult> {
  ...
  const response = await fetch(
    "http://app-dysgncsaheyp-api-rY7JzDpZVBQL-gateway.appmiaoda.com/v1/images/edits",
    {
      method: "POST",
      headers: {
