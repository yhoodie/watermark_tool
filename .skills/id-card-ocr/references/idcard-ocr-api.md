...
| third_part_domain | `app-dysgncsaheyp-api-k93RZBjP0zqa-gateway.appmiaoda.com` |
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstream = await fetch(
    "https://app-dysgncsaheyp-api-k93RZBjP0zqa-gateway.appmiaoda.com/rest/2.0/ocr/v1/idcard",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/x-www-form-urlencoded",
...
- **第三方域名**：实际请求转发至 `app-dysgncsaheyp-api-k93RZBjP0zqa-gateway.appmiaoda.com`，网关代理后客户端无需感知。
