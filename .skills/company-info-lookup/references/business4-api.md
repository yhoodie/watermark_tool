...
| Endpoint | `GET https://app-dysgncsaheyp-api-e94GZ5j0Kxja-gateway.appmiaoda.com/business4/get` |
| Auth 模式 | platform_managed |
| Auth Header | `X-Gateway-Authorization: Bearer ${apiKey}` |
| Content-Type | `application/json;charset=UTF-8` |
| third_part_domain | `app-dysgncsaheyp-api-e94GZ5j0Kxja-gateway.appmiaoda.com` |
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstreamUrl = new URL(
    "https://app-dysgncsaheyp-api-e94GZ5j0Kxja-gateway.appmiaoda.com/business4/get"
  );
