...
| Endpoint | `POST https://app-dysgncsaheyp-api-pLVzAxRQyMWL-gateway.appmiaoda.com/vehiclelimit/query` | `POST https://app-dysgncsaheyp-api-DYJwnJVBwb4a-gateway.appmiaoda.com/vehiclelimit/city` |
| Auth Header | `X-Gateway-Authorization: Bearer ${INTEGRATIONS_API_KEY}` | 同左 |
| Content-Type | `application/json;charset=UTF-8` | `application/json;charset=UTF-8` |
| third_part_domain | `app-dysgncsaheyp-api-pLVzAxRQyMWL-gateway.appmiaoda.com` | 同左 |
| 计费 | 是 | 否 |
...
serve(async (req: Request): Promise<Response> => {
  ...
  // --- 调用上游 ---
  const url = new URL(
    "https://app-dysgncsaheyp-api-pLVzAxRQyMWL-gateway.appmiaoda.com/vehiclelimit/query"
  );
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstream = await fetch(
    "https://app-dysgncsaheyp-api-DYJwnJVBwb4a-gateway.appmiaoda.com/vehiclelimit/city",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json;charset=UTF-8",
