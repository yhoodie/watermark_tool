...
| Endpoint | `POST http://app-dysgncsaheyp-api-Aa2P8AGZg2RL-gateway.appmiaoda.com/v1/images/generations` |
...
async function createImage(params: CreateImageParams): Promise<CreateImageResult> {
  const response = await fetch(
    "http://app-dysgncsaheyp-api-Aa2P8AGZg2RL-gateway.appmiaoda.com/v1/images/generations",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
