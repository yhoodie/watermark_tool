...
| third_part_domain | `app-dysgncsaheyp-api-DY8MN3QBydBa-gateway.appmiaoda.com` |
...
| 方法 | POST |
| Endpoint | `https://app-dysgncsaheyp-api-DY8MN3QBydBa-gateway.appmiaoda.com/v1/videos/image2video` |
| 计费 | 启用（按调用次数计费） |
...
| 方法 | GET |
| Endpoint | `https://app-dysgncsaheyp-api-zYkZzgKook1L-gateway.appmiaoda.com/v1/videos/image2video/{id}` |
| 计费 | 不启用 |
...
| 方法 | GET |
| Endpoint | `https://app-dysgncsaheyp-api-n9QVoDJ6oykL-gateway.appmiaoda.com/v1/videos/image2video` |
| 计费 | 不启用 |
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstream = await fetch(
    "https://app-dysgncsaheyp-api-DY8MN3QBydBa-gateway.appmiaoda.com/v1/videos/image2video",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
...
serve(async (req: Request): Promise<Response> => {
  ...
  // --- 查询任务 ---
  const upstream = await fetch(
    `https://app-dysgncsaheyp-api-zYkZzgKook1L-gateway.appmiaoda.com/v1/videos/image2video/${task_id}`,
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
