...
| 接口 | 方法 | Endpoint | 说明 |
|------|------|----------|------|
| 创建图片 | POST | `https://app-dysgncsaheyp-api-wLNdpny6ZpVa-gateway.appmiaoda.com/image2` | 根据文本描述生成图片 |
| 编辑图片 | POST | `https://app-dysgncsaheyp-api-wLNdpny6ZpVa-gateway.appmiaoda.com/image2` | JSON Base64 图片编辑融合 |
