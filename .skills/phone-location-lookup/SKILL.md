...
- **Endpoint**：`POST https://app-dysgncsaheyp-api-ELbWz8OmB58Y-gateway.appmiaoda.com/mobile/area`
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstreamUrl = new URL("https://app-dysgncsaheyp-api-ELbWz8OmB58Y-gateway.appmiaoda.com/mobile/area");
