...
- **Endpoint**: `GET https://app-dysgncsaheyp-api-Aa2PZnjE80BL-gateway.appmiaoda.com/company_three/get`
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstream = await fetch(
    `https://app-dysgncsaheyp-api-Aa2PZnjE80BL-gateway.appmiaoda.com/company_three/get?${params.toString()}`,
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json;charset=UTF-8",
...
- **third_part_domain**: `app-dysgncsaheyp-api-Aa2PZnjE80BL-gateway.appmiaoda.com`
